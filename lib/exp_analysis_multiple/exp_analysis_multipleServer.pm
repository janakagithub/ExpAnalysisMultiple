package exp_analysis_multiple::exp_analysis_multipleServer;
...
our %return_counts = (
        'exp_analysis_multiple' => 1,
        'exp_analysis_multiple_async' => 1,
        'exp_analysis_multiple_check' => 1,
        'version' => 1,
);

our %method_authentication = (
        'exp_analysis_multiple' => 'required',
        'exp_analysis_multiple_async' => 'required',
        'exp_analysis_multiple_check' => 'required',
);
...
sub call_method {
    ...
    my $ctx = exp_analysis_multiple::exp_analysis_multipleServerContext->new($self->{loggers}->{userlog},
...

{
    ...
    my @result;
    {
        ...
        my $stderr = exp_analysis_multiple::exp_analysis_multipleServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
package exp_analysis_multiple::exp_analysis_multipleServerContext;

use strict;

=head1 NAME

exp_analysis_multiple::exp_analysis_multipleServerContext
...
package exp_analysis_multiple::exp_analysis_multipleServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = exp_analysis_multiple::exp_analysis_multipleServer->new(
