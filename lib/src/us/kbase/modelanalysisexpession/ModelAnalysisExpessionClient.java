...
/**
 * <p>Original spec-file module name: model_analysis_expession</p>
 * <pre>
 * A KBase module: exp_analysis_multiple
 * This module compare multiple_pathway analysis_objects
 * </pre>
 */
public class ModelAnalysisExpessionClient {
     ...
     */
    public ModelAnalysisExpessionClient(URL url) {
     ...
     * validity.
     */
    public ModelAnalysisExpessionClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ModelAnalysisExpessionClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * @return   instance of type {@link us.kbase.modelanalysisexpession.FBAPathwayAnalysisMultiple FBAPathwayAnalysisMultiple}
    ...
    public FBAPathwayAnalysisMultiple expAnalysisMultiple(String arg1, List<String> arg2, String arg3, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FBAPathwayAnalysisMultiple> res = caller.jsonrpcCall("model_analysis_expession.exp_analysis_multiple", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
}
